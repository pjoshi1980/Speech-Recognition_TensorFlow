...
def load_variables_from_checkpoint(sess, start_checkpoint):
    ...
    """
    saver = tf.train.Saver(tf.global_variables())
    saver =    tf.train.import_meta_graph('D:/home/sthin/workspace/kaggle/tensorflowgraphdef/speech_commands/speech_commands_train/cpkt/conv.ckpt-4200.meta')
    """
    saver.restore(sess, start_checkpoint)
    """
    saver.restore(sess,tf.train.latest_checkpoint('D:/home/sthin/workspace/kaggle/tensorflowgraphdef/speech_commands/speech_commands_train/cpkt/'))
